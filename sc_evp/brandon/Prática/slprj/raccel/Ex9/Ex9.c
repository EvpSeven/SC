...
"slprj\\raccel\\Ex9\\Ex9_Jpattern.mat" ; const int_T gblNumRootInportBlks = 0
...
& model_S ; void MdlInitialize ( void ) { rtX . gmlozp1kif = rtP .
Integrator_IC ; rtX . n22o3mkyoa = rtP . Integrator1_IC ; } void MdlStart (
...
( int_T tid ) { real_T tmp ; rtB . cx3elwcung = rtX . gmlozp1kif ; if (
ssIsSampleHit ( rtS , 1 , 0 ) ) { rtDW . oemw3qxaoa = ( ssGetTaskTime ( rtS ,
1 ) >= rtP . Step_Time ) ; if ( rtDW . oemw3qxaoa == 1 ) { tmp = rtP .
Step_YFinal ; } else { tmp = rtP . Step_Y0 ; } rtB . ba4ldi20lm = 1.0 / rtP .
R * tmp ; } rtB . fi44ybxvby = 1.0 / rtP . R * rtB . cx3elwcung ; rtB .
aqrbihpzht = rtB . ba4ldi20lm - rtB . fi44ybxvby ; rtB . jv02ptlwch = rtX .
n22o3mkyoa ; rtB . k5gis2f3er = rtB . aqrbihpzht - rtB . jv02ptlwch ; rtB .
o253h2i5de = 1.0 / rtP . C * rtB . k5gis2f3er ; rtB . epy1dlcxu3 = 1.0 / rtP
. L * rtB . cx3elwcung ; UNUSED_PARAMETER ( tid ) ; } void MdlUpdate ( int_T
tid ) { UNUSED_PARAMETER ( tid ) ; } void MdlDerivatives ( void ) { XDot *
_rtXdot ; _rtXdot = ( ( XDot * ) ssGetdX ( rtS ) ) ; _rtXdot -> gmlozp1kif =
rtB . o253h2i5de ; _rtXdot -> n22o3mkyoa = rtB . epy1dlcxu3 ; } void
MdlProjection ( void ) { } void MdlZeroCrossings ( void ) { ZCV * _rtZCSV ;
_rtZCSV = ( ( ZCV * ) ssGetSolverZcSignalVector ( rtS ) ) ; _rtZCSV ->
cabfe0pkit = ssGetT ( rtS ) - rtP . Step_Time ; } void MdlTerminate ( void )
...
2 ) ; ssSetNumBlocks ( rtS , 10 ) ; ssSetNumBlockIO ( rtS , 8 ) ;
ssSetNumBlockParams ( rtS , 8 ) ; } void MdlInitializeSampleTimes ( void ) {
ssSetSampleTime ( rtS , 0 , 0.0 ) ; ssSetSampleTime ( rtS , 1 , 0.0 ) ;
ssSetOffsetTime ( rtS , 0 , 0.0 ) ; ssSetOffsetTime ( rtS , 1 , 1.0 ) ; }
void raccel_set_checksum ( ) { ssSetChecksumVal ( rtS , 0 , 3152738345U ) ;
ssSetChecksumVal ( rtS , 1 , 3709429346U ) ; ssSetChecksumVal ( rtS , 2 ,
2372624493U ) ; ssSetChecksumVal ( rtS , 3 , 2337009829U ) ; }
#if defined(_MSC_VER)
#pragma optimize( "", off )
#endif
...
Ex9_InitializeDataMapInfo ( ) ; ssSetIsRapidAcceleratorActive ( rtS , true )
; ssSetRootSS ( rtS , rtS ) ; ssSetVersion ( rtS , SIMSTRUCT_VERSION_LEVEL2 )
; ssSetModelName ( rtS , "Ex9" ) ; ssSetPath ( rtS , "Ex9" ) ; ssSetTStart (
rtS , 0.0 ) ; ssSetTFinal ( rtS , 0.003 ) ; { static RTWLogInfo
...
ssSetChecksumVal ( rtS , 0 , 3152738345U ) ; ssSetChecksumVal ( rtS , 1 ,
3709429346U ) ; ssSetChecksumVal ( rtS , 2 , 2372624493U ) ; ssSetChecksumVal
( rtS , 3 , 2337009829U ) ; { static const sysRanDType rtAlwaysEnabled =
