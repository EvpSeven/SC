...
MODEL               = Ex9
MODULES             = rt_logging.c Ex9.c Ex9_capi.c Ex9_data.c Ex9_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
MAKEFILE            = Ex9.mk
...
MASTER_ANCHOR_DIR   = 
START_DIR           = C:/Users/andre/OneDrive - Universidade de Aveiro/SC/Prática
...
rtiostream_utils.obj : C:\Program\ Files\MATLAB\R2019b\toolbox\coder\rtiostream\src\utils/rtiostream_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\MATLAB\R2019b\toolbox\coder\rtiostream\src\utils/rtiostream_utils.c
